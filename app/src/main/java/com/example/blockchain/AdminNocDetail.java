...
public class AdminNocDetail extends AppCompatActivity {

    ImageView offerCheck, idCheck, declarationCheck;
    String pdfOfferUri, pdfIdUri, pdfdeclUri;
    String studentKey;
    AppCompatButton nocBackBtn, approveBtn, rejectBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_noc_detail);

        offerCheck = findViewById(R.id.offer_check_admin);
        idCheck = findViewById(R.id.id_check_admin);
        declarationCheck = findViewById(R.id.declaration_check_admin);
        nocTypeSpinner = findViewById(R.id.noc_type_spinner_admin);
        nocBackBtn = findViewById(R.id.noc_back_btn_admin);
        companyName = findViewById(R.id.noc_company_name_edtTxt_admin);
        companyAddress = findViewById(R.id.noc_company_address_edtTxt_admin);
        companyPhone = findViewById(R.id.company_phone_number_edtTxt_admin);
        approveBtn = findViewById(R.id.noc_register_btn_admin);
        nocBackBtn = findViewById(R.id.noc_back_btn_admin);
        rejectBtn = findViewById(R.id.noc_reject_btn_admin);
        ...
        approveBtn.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), AdminNocRemark.class).putExtra("key",studentKey).putExtra("type","0"));
        });
        rejectBtn.setOnClickListener(v -> {
            startActivity(new Intent(getApplicationContext(), AdminNocRemark.class).putExtra("key",studentKey).putExtra("type","1"));
        });
    }
